//
//  main.cpp
//  shrinking the binary image
//
//  created by Yi Zheng on 10/26/15.
//	version 2.0
//
...

{
    ...
    int uncon_mask[106] = {1000000,10000,
                          10,10000000,
                          11000000,1100000,110000,11000,1100,110,11,10000001,
    ...
    for (i=0;i<size_h;i++) {
        for (j=0;j<size_w;j++) {
            //tmp_w[i][j] = (int)imagedata[i][j]/255;       // for counting the white circles
            tmp_w[i][j] = 1-(int)imagedata[i][j]/255;     // for counting the black dots
        }
    }
    for(l=0;l<10;l++)    // iteration times
    {
    ...
    // use counting filter to count the number
    for (i=2;i<size_h-2;i++){
        for (j=2;j<size_w-2;j++){
            if(tmp_w[i][j]==1){
            if(tmp_w[i-2][j-2]==0&&tmp_w[i-2][j-1]==0&&tmp_w[i-2][j]==0&&tmp_w[i-2][j+1]==0&&tmp_w[i-2][j+2]==0){
                if(tmp_w[i-1][j-2]==0&&tmp_w[i-1][j-1]==0&&tmp_w[i-1][j]==0&&tmp_w[i-1][j+1]==0&&tmp_w[i-1][j+2]==0){
                    if(tmp_w[i][j-2]==0&&tmp_w[i][j-1]==0&&tmp_w[i][j+1]==0&&tmp_w[i][j+2]==0){
                        if(tmp_w[i+1][j-2]==0&&tmp_w[i+1][j-1]==0&&tmp_w[i+1][j]==0&&tmp_w[i+1][j+1]==0&&tmp_w[i+1][j+2]==0){
                            if(tmp_w[i+2][j-2]==0&&tmp_w[i+2][j-1]==0&&tmp_w[i+2][j]==0&&tmp_w[i+2][j+1]==0&&tmp_w[i+2][j+2]==0){
                                count = count+1;
                            }
